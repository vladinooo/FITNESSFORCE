...
public class UsersDao {
	...
	//
	// return
	// jdbc.update("update offers set name=:name, text=:text, email=:email where id=:id",
	// params) == 1;
	// }
	//
	@Transactional
	...
	//
	// return
	// jdbc.batchUpdate("insert into offers (id, name, text, email) values (:id, :name, :text, :email)",
	// params);
	// }
	//
